...
print(f'Power grid: n={n}, beta_e=0.0055, route=Fiedler')
print()
...
json.dump({'name':'power_grid','n':n,'beta_e':0.0055,'asym':0.137,
           'fc':fcm,'fi':fim,'winner':w,'p':p,'pred':'Fiedler',
           'correct':w=='Fiedler'},
    open('results/power_grid_result.json','w'),indent=2)
