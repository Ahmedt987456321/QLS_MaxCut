...
print(f'Walshaw data FEM mesh: n={n}, beta_e=0.017, route=Fiedler')
print(f'Running AQLS: k={k}, budget={BUDGET}s, trials={TRIALS}')
print()
...
json.dump({'name':'data_fem','n':n,'beta_e':0.017,'asym':0.180,
           'fc':fcm,'fi':fim,'winner':w,'p':p,'pred':'Fiedler',
           'correct':w=='Fiedler'},
    open('results/walshaw_data_result.json','w'),indent=2)
